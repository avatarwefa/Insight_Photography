                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <article class=" border-0 rounded-0 mb-4">
                            <img src="images/item-1.jpg" alt="" class="img-responsive">
                            <div class="mt-3 px-4 py-3 ">
                                <div class="blog-post-meta text-capitalize mb-2">
                                    <a href="#"><h4><i class="ti-crown mr-2"></i>LYOS</h4> </a>
                                </div>
                                <a href="product_detail.html"><h4 class="mb-3 font-secondary">UNIQUE TIGER T-SHIRT</h3></a>
                                <p><i class="ti-tag mr-2"></i>449,000₫</p>
                                <a href="#" class="text-blue mb-3 d-block"><i class="ti-shopping-cart mr-2"></i> Add to Cart</a>
                            </div>
                        </article>
                    </div>
                    <div class="col-lg-4 col-md-6">
